...
4. Create a read-only developer diagnostic agent that can fetch bounded container/application logs, summarize the execution path, and explain under-the-hood failures for support/debugging.
